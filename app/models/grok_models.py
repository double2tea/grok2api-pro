...
_MODEL_CONFIG: Dict[str, Dict[str, Any]] = {
    ...
    "grok-4.1": {
        ...
        "description": "Grok 4.1 redirected to fast non-reasoning model",
        "raw_model_path": "xai/grok-3",
        "default_temperature": 1.0,
        "default_max_output_tokens": 8192,
        "supported_max_output_tokens": 131072,
    ...
    "grok4.1": {
        ...
        "requires_super": False,
        "display_name": "Grok 4.1",
        "description": "Alias of grok-4.1 redirected to fast non-reasoning model",
        "raw_model_path": "xai/grok-3",
        "default_temperature": 1.0,
        "default_max_output_tokens": 8192,
        "supported_max_output_tokens": 131072,
    ...
    "grok-4.1-thinking": {
        "grok_model": ("grok-4-1-thinking-1129", "MODEL_MODE_UNKNOWN"),
    ...
    "grok-4-1-fast-non-reasoning": {
        "grok_model": ("grok-4-1-fast-non-reasoning", "MODEL_MODE_GROK_4_1"),
        "rate_limit_model": "grok-4-1-fast-non-reasoning",
        "cost": {"type": "low_cost", "multiplier": 1, "description": "计1次调用"},
        "requires_super": False,
        "display_name": "Grok 4.1 Fast (Non-Reasoning)",
        "description": "Fast non-reasoning Grok 4.1 model",
        "raw_model_path": "xai/grok-4-1-fast-non-reasoning",
        "default_temperature": 1.0,
        "default_max_output_tokens": 8192,
        "supported_max_output_tokens": 131072,
        "default_top_p": 0.95
